...
def init_data():
    ...
    print(pair_history.columns)
    dataframe = populate_indicator(pair_history)
    x,y,val,valy,test,testy = datatoolstest.build_forecast_ts_training_dataset(dataframe, 
                                                                  n_interval=2,
                                                                  input_width=5,
                                                                  label_width=3,
                                                                  test_val_prop=0.1,
    ...
    return x,y,val,valy,test,testy
...
def populate_indicator(dataframe : pd.DataFrame) -> pd.DataFrame:
    data = dataframe.copy()
    # Momentum Indicators
    # ------------------------------------
    # ADX
...
#   data.dropna(inplace=True) # si tu le veux
    return dataframe
