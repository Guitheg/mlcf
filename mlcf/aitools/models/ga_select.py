...
def run_nn_model(ts_data:WTSeriesTraining, ndim=glb_raw_data.shape[1], input_size=20, n_epoch = 1,
                                    batch_size= 5, learning_rate = 0.1, loss=L1Loss(),metrics=[L2]):
        # print(data.columns)
...
class GA_SELECT(SuperModule):
    ...
    def create_algorithm_parameters(self, max_num_iteration = None,
                                    population_size = 100,
                                    mutation_probability = 0.1,
                                    elit_ratio = 0.01,
                                    crossover_probability = 0.5,
        ...
        alg_param = {'max_num_iteration': max_num_iteration,
    ...
    def create_ga_model(self):
        alg_param = self.create_algorithm_parameters(self.max_num_iteration,
        ...
        ga_model = ga(function=self.loss_function, variable_type='bool',
                        dimension=self.ndim,
