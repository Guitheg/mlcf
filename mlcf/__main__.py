...
def main():
    ...
    # freqtrade
    group_freqtrade = command_build.add_argument_group("Data download information",
    ...
    # - wtst
    group_wtst = command_build.add_argument_group("Windowed Time Series Training data information",
    ...
    command_train.add_argument("--param",
