...
class CrossingMovingAverage(IStrategy):
    """
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                (qtpylib.crossed_above(dataframe['sma50'], dataframe['ema50'])) &  # Signal: sma crosses above ema
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                (qtpylib.crossed_above(dataframe['ema50'], dataframe['sma50'])) &  # Signal: ema crosses above sma
                (dataframe['volume'] > 0)  # Make sure Volume is not 0
            ),
            'sell'] = 1
        return dataframe
